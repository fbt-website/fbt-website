        ...
        <section className="py-20 sm:py-24 lg:py-32" aria-labelledby="how-we-work-heading">
            <Container>
                <div className="text-center">
                    ...
                    <h2 id="how-we-work-heading" className="mt-3 text-xl font-semibold text-slate-900 sm:text-2xl">
                        How We Work
                    </h2>
                ...
                <ul className="mx-auto mt-10 max-w-md space-y-3 text-sm text-slate-700 sm:mt-14 sm:space-y-4 sm:text-base" role="list">
                    {principles.map((item) => (
